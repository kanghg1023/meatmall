...
<body>
<form action="faqupdateboard.do" method="post" style="margin-bottom: 70px;">
	...
	<table class="list-table" style="width:70%;">
		...
		<tr>
			<td colspan="2">
				<input type="submit" value="수정완료" class="faqbtn" />
				<button type="button" onclick="location.href='faqlist.do'" class="faqbtn">글목록</button>
			</td>
		</tr>
	</table>
</form>
